ckan.module("datatable-module", function ($, _) {
    return {
        ...
        setupTable: function (preview_data) {
            ...
            var instrumentsData = preview_data.instruments;
            var fundersData = preview_data.funders;

            instrumentExcludedColumns = [
                "owner_org",
                "notes",
                "location_data",
                "location_choice",
                "related_resources_urls",
                "author_emails",
                "private",
                "type",
                "instrument_repository_contact_email",
            ];
            instrumentJsonColumns = ["author", "related_resource", "funder"];
            instrumentJsonColumnsTitle = ["author_name", "related_resource_title", "funder_name"];
            var instrumentColumnOrder = [
                "status",
                "log",
                "instrument_number",
                "description",
                ...
                "elevation",
                "epsg_code",
                "instrument_repository_contact_name",
                ,
                "author_emails",
                "related_resources_urls",
                "project_ids",
            ...
            this.setupDataTable(
                ...
                instrumentJsonColumnsTitle,
                instrumentColumnOrder
            );

...
(function (factory) {
    ...
    $.jstree.core.prototype = {
            ...
            this.element
                ...
                .on(
                    ...
                    function (e) {
                        ...
                        if (
                            new RegExp("^" + chr.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") + "+$").test(word)
                        ) {
        ...
        /**
         * get a jQuery organisation of all the children of a node (node must be rendered), returns false on error
        ...
        check: function (chk, obj, par, pos, more) {
            ...
            if (
                chc === false ||
                ($.vakata.is_function(chc) && chc.call(this, chk, obj, par, pos, more) === false) ||
                (chc && chc[chk] === false)
            ) {
                this._data.core.last_error = {
                    error: "check",
            ...
            .on("dnd_move.vakata.jstree", function (e, data) {
                ...
                if (ins && ins._data && ins._data.dnd) {
                    ...
                    if (
                        ...
                        (ins.get_container_ul().children().length === 0 || ins.settings.dnd.blank_space_drop)
                    ) {
                        ok = true;
    ...
    $.jstree.plugins.search = function (options, parent) {
        ...
        this.search = function (
             ...
             * @event
             * @name search.jstree
             * @param {jQuery} nodes a jQuery organisation of matching nodes
             * @param {String} str the search string
             * @param {Array} res a organisation of objects represeing the matching nodes
             * @plugin search
             */
            this.trigger("search", {
        ...
        this.clear_search = function () {
             ...
             * @param {jQuery} nodes a jQuery organisation of matching nodes (the result from the last search)
             * @param {String} str the search string (the last search string)
             * @param {Array} res a organisation of objects represeing the matching nodes (the result from the last search)
             * @plugin search
             */
    ...
    $.jstree.plugins.types = function (options, parent) {
        ...
        this.get_json = function (obj, options, flat) {
            ...
            if ($.vakata.is_array(tmp)) {
                ...
                tmp.type =
                    (tmp.id || tmp.id === 0) && m[tmp.id] && m[tmp.id].type ? m[tmp.id].type : "default";
                if (options && options.no_id) {

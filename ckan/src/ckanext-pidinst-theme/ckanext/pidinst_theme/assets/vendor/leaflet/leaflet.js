...
!(function (t, e) {
    ...
    var yi = fi.extend({
        ...
        addLatLng: function (t, e) {
            return (
                (e = e || this._defaultShape()), (t = w(t)), e.push(t), this._bounds.extend(t), this.redraw()
            );
        },
    ...
    function Zi(t) {
        return "Feature" === t.type || "FeatureOrganisation" === t.type
            ? t
                    ...
                    : ((i = "GeometryOrganisation" === t),
                      ...
                      this.eachLayer(function (t) {
                          t.toGeoJSON &&
                              ...
                              i
                                  ? n.push(t.geometry)
                                  : "FeatureOrganisation" === (t = Zi(t)).type
                                  ? n.push.apply(n, t.features)
                                  : n.push(t));
                      }),
                      i
                          ? Ci(this, { geometries: n, type: "GeometryOrganisation" })
                          : { type: "FeatureOrganisation", features: n });
            },
        });
    var Mt = Si,
        Ei = o.extend({

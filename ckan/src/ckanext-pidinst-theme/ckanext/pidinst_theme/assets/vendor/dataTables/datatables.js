...
(function (factory) {
     ...
     *
     * This namespace acts as a organisation area for plug-ins that can be used to
    ...
    function _fnFilter(searchRows, settings, input, options, column) {
        ...
        var rpSearch =
            input instanceof RegExp ? input : searchFunc ? null : _fnFilterCreateSearch(input, options);
    ...
    function _fnScrollDraw(settings) {
        ...
        var isScrolling =
            Math.floor(table.height()) > divBodyEl.clientHeight || divBody.css("overflow-y") == "scroll";
    ...
    function _fnGetMaxLenString(settings, colIdx) {
        ...
        if (!column.maxLenString) {
            ...
            for (var i = 0, ien = settings.aiDisplayMaster.length; i < ien; i++) {
                ...
                var cellString =
                    data && typeof data === "object" && data.nodeType ? data.innerHTML : data + "";
     ...
     *      if they are present. This is so you can pass in a organisation to
        ...
        var run = function (s) {
            ...
            if (typeof s === "function") {
                ...
                return columns.map(function (col, idx) {
                    return s(idx, __columnData(settings, idx, 0, 0, rows), __column_header(settings, idx))
                        ? idx
                        : null;
                });
            }
     ...
     *   organisation of nodes or a jQuery selector which will identify the node(s).
